...
$MAILNONVA = FALSE; // finché è vero che le mail non partono, scrivo cose x gli utenti.
$UPLOADVA = FALSE;  
$GETUTENTE = getUtente();
$ISANONIMO = anonimo();
$ISSERIO = Session('serio');

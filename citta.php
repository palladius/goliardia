...
?>
<h1>
	<?php  echo  ($m_bCittaNostrana ? "Città" : "Nazioni")?>
</h1>
<?php 
tabled();
...
if (mysql_num_rows($res2)==0)
	{scrivib(rossone("ATTENZIONE!!! La tua provincia (ora ha valore '<i>".Session("provincia")."</i>') non esiste nel database. Vai nella sezione UTENTE, in basso, e correggila con qualcosa di appropriato; magari in futuro contatta il webmaster affinchè aggiunga la città/nazione in cui ti trovi adesso..."));
	 bona();
	}

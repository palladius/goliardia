...
function visualizzaInteri($result,$rowSqlLast10Messaggi) {
 ...
 $totaleThread = mysql_num_rows($result); # thread rimasti, non puoi visualizzarne 10 se ne hai 3 !!!

 for ($j=0; $j < $quantiNeVisualizzoINTERAMENTE && $j < $totaleThread ; $j++) {
...
<table >
 ...
 <td width="30%" valign=top>
	<h3>Ultimi <i><?php  echo $nMessaggiASinistra?></i> thread </h3>
	 <?php   stampaMessaggi($nMessaggiASinistra,8,FALSE,1) // ultimi N msg con char alto 8, INSICURO ?>
	<h3>Ultime <i><?php  echo $NUM_MSG_FUOCO?></i> risposte (hottest)</h3>
	 <?php   stampaMessaggi($NUM_MSG_FUOCO,8,FALSE,0) // ultimi N msg con char alto 8, INSICURO ?>
 </td>

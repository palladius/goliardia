...
<table width="<?php  echo $CONSTLARGEZZA600?>" border="1">
 <tr>
  <td width="30%" valign=top>
   <h1>Agenda e-mail degli amministratori del sito</h1>
...
$rs2=mysql_query("select m_snome as utente,m_hemail as _email,msn,icq as skype, provincia as goliarda from loginz where m_bmailpubblica=1 AND m_bisgoliard=1 AND m_badmin = 1 ORDER BY provincia,m_snome");

scriviRecordSetConTimeout($rs2,406,"Agenda degli utentiregistrati","Questa lista contiene, in ordine alfabetico, gli Utenti consenzienti a mettere la propria E-mail pubblica, che risultano NON FILISTEI e registrati"); // a regime 10
?>
